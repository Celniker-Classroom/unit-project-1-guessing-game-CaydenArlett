...
Added sytling features to create an appealing viusual layout

1. Created a backround with gradient
...
4. The buttons also get brighter when hovered over and have drop shadows
